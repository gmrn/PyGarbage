...
4. Создать новый вектор `fixed_vector`, где все пропущенные значения вектора данного по условию `my_vector` будут заменены на его среднее значение по имеющимся наблюдениям.
